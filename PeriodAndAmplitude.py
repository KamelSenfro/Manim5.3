...
######################################################
        ...
        self.wait()
        #self.play(DrawBorderThenFill(VGroup(YT))) #Outro SVGs , IG, RD, DS
