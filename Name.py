...
#class halfCircleSquareExample(Scene):
        def construct(self):
            ...
            R = Sector(radius=6, start_angle=start_angle, angle=-end_angle, color=GREEN, 
                        fill_opacity=1, stroke_color=[BLUE_A,GREEN_A], stroke_width=2) 
            L = Sector(radius=6, start_angle=start_angle, angle=end_angle, color=GREEN, fill_opacity=1,
...
#class QuarterCircleSquareExample(Scene):
            ...
            DR = Sector(radius=6, start_angle=start_angle, angle=-end_angle, color=GREEN, 
                        fill_opacity=1, stroke_color=[BLUE_A,GREEN_A], stroke_width=2) 
            UR = Sector(radius=6, start_angle=start_angle, angle=end_angle, color=GREEN, fill_opacity=1,
                        stroke_color=[BLUE_A,GREEN_A], stroke_width=2)
            DL = Sector(radius=6, start_angle=-np.pi, angle=end_angle, color=GREEN, 
                        fill_opacity=1, stroke_color=[BLUE_A,GREEN_A], stroke_width=2)
            UL = Sector(radius=6, start_angle=-np.pi, angle=-end_angle, color=GREEN, 
                        fill_opacity=1,  stroke_color=[BLUE_A,GREEN_A], stroke_width=2)
